...
do
{
    ...
    switch (menuSelection)
    {
        ...
        case "2":
            ...
            string dogCharacteristc = "";

            while (dogCharacteristc == "")
            {

                Console.WriteLine($"\nWrite the specified characteristc: ");
                readResult = Console.ReadLine();
                if (readResult != null)
                {
                ...
                if (noMatchesDog)
                {
                    Console.WriteLine("None of our dogs are a match found for: " + dogCharacteristc);
                }
